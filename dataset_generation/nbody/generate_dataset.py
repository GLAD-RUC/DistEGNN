...
parser.add_argument('--clusters', type=int, default=1,
                    help='Number of gaussion distributions')

args = parser.parse_args()

suffix = '_charged'

suffix += str(args.n_isolated) + '_' + str(args.n_stick) + '_' + str(args.n_hinge) + '_' + str(args.clusters) + args.suffix
...
def para_comp(length, sample_freq):
    while True:
        ...
        system = System(n_isolated=args.n_isolated, n_stick=args.n_stick, n_hinge=args.n_hinge, box_size=args.box_size, clusters=args.clusters)
